...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('notifications-dropdown', __webpack_require__(12));
});
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                axios.get(action.url).then(function (_ref2) {
                  var data = _ref2.data;
                  ...
                  if ('hidesNotification' in action && action.hidesNotification) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return !_vm.shouldHide
    ? _c("div", { staticClass: "block no-underline text-90 hover:bg-30 p-3" }, [
        _c(
          "div",
              ...
              [
                _vm._t("content", [
                  ...
                  _vm.notification.data.subtitle
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  "actions" in _vm.notification.data
                    ? _c(
                        "p",
                        { staticClass: "pb-2 font-normal" },
                        _vm._l(_vm.notification.data.actions || [], function(
                          action
                        ) {
                          return _c("button", {
                            key: action.label,
...
var update = __webpack_require__(16)("118a3328", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    notificationReceived: function notificationReceived(notification) {
      ...
      if (!('actions' in notification || notification.actions.length > 0)) {
        ...
        notification.actions.forEach(function (action) {
          actions.push({
            text: self.__(action.label),
            onClick: function onClick(e, toast) {
              self.$refs['notification-' + notification.id][0].handleAction(action);
              toast.goAway(0);
            }
          });
        });
      ...
      _c("dropdown-trigger", { staticClass: "h-9 flex items-center" }, [
        _c("span", { staticClass: "relative" }, [
          _c(
            "svg",
            {
              staticClass: "ml-2 text-90 bg-gray-800 w-8",
              attrs: {
